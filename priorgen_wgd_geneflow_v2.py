...
import sys
n1, n2, nA, tau, M, alpha, shape1, shape2 = [], [], [], [], [], [], [], []
...
\tEx:\n\
\t\033[1;32m./priorgen_v2.py bpfile=bpfile_test.txt n1=0 n1=1 n2=1 n2=2 nA=2 nA=3 tau=0 tau=4 alpha=0 alpha=1 nreps=10 M=0 M=10 shape1=0 shape1=10 shape2=0 shape2=100 model=allo migModel=migAB symModel=asym MVariation=hetero parameters=output.txt\033[1;m\n\n\
